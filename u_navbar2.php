...
<div class="outer-wrap">
  ...
  <div class="centered">
    <div class="site-branding">
      ...
      <h1 class="site-title"><a href="index.php"><i title="Back to home"class="fas fa-book-open" style="color: white;font-size: 34px; text-decoration: none;padding: 10px;"></i></a>Library Management System </h1>
    </div><!-- .site-title -->
  </div><!-- .centered -->
